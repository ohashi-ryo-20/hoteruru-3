...
public class AuthController {
	...
	@PostMapping("/signup")
	public String register(@ModelAttribute @Validated SignupForm signupForm, BindingResult bindingResult, RedirectAttributes redirectAttributes, HttpServletRequest httpServletRequest) {
		if (userService.isEmailRegister(signupForm.getEmail())) {
